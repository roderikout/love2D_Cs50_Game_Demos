...
--Ball:collides expects a paddle as an argument and returns true or false, depending
-- on whether their rectangles overlap.

function Ball:collides(paddle)
	--first, check to see if the left edge of either is farther to the right than
	-- the right edge to the other
	...
	-- if the above aren't true, they're ovelapping
	return true
end